...
def saludar(nombre, apellido1, apellido2):
    ...
    # Con esto podemos poner una explicacion de que hace la funcion (se muestra con help(...), para salir: CTRL+Z)
    """Imprime por pantalla un mensaje saludando a la persona en función de los parámetros de entrada""" 
    
    print(f"Hola {nombre} {apellido1} {apellido2}")


saludar("Carlos", "Pérez", "Garcia")
